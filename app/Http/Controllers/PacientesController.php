...
class PacientesController extends Controller
{
    ...
    {
    if ($paciente->email != $request->input('email') && $request->input('passwordN') != "") {
        $datos = $request->validate([
            'name' => ['required'],
            'documento' => ['required'],
    ...
    } else if ($paciente->email != $request->input('email') && $request->input('passwordN') == "") {
    ...
    return redirect('Pacientes')->with('actualizarP', 'Si');
